...
String query="select b.alumina_id, b.detail_id,b.name,b.date,b.weight,s.size,p.periode from alumina b JOIN SIZE s on b.size_id=s.size_id join periode p on b.periode=p.id  where detail_id='"+id+"'";
...
<br>
 <ul class="breadcrumbs">
    ...
    <li><a href="#">Detail Formula Alumina</a></li>
</ul> 
<div class="example" data-text="Detail Formula Alumina"  style="margin-left: 30px">
    ...
    <table class="table-bordered table table-condensed" border="1" >
        ...
        <% 
String qu="select * from aluminaDetail b join items i on b.items_id=i.items_id  where detail_id='"+id+"'";
...
<tr>
    ...
    <td align="center" colspan="2"><% out.print(String.format("%.4f",a.getweightDry(id))); %></td>
</tr>
<tr>
    <td colspan="2">Costt Dry Rp/M&sup2;</td>  
    <td align="center" colspan="2"><% out.print(nf.format(a.getCostDry(id))); %></td>
</tr>
    </table>
