...
String query="select * from sch join prices on sch.price_id=prices.prices_id join persen on prices.persen_id=persen.persen_id join line on persen.line_id=line.line_id";
...
double pkw6=Math.round((kw6/qty)*100);
...
String mkw6=nf.format(kw6)+" ("+nf.format(pkw6)+"%)";
