...
$(document).ready(function(){   
     $("#weightwet").keyup(function(){
          var size=$("#size").val();
          var weight=$("#weightwet").val();
          $.ajax({
              type:"POST",
              url:"pasta/wetWeight.jsp",
          ...
          clearData();
          var comboBody="";
          $.getJSON("pasta/getPasta.jsp?per="+per,function(data){  
              comboBody+="<option >Choose Glaze</option>";
          $.each(data,function(index,item) 
          {
          comboBody+="<option value='"+item.id+"'>"+item.name+"&nbsp;"+item.size+"&nbsp;"+item.color+"&nbsp;("+item.option+")</option>";
          });
          $("#cari").html(comboBody);        
          });
          });
       ...
       $("#size").html(items);        
        ...
        $("#costdry").mouseover(function(){
         ...
         $("#simpan").click(function(){
          ...
          var per=$("#periode").val();
          var color=$("#color").val();
          var keluar = {"detailId":"", "idPasta":"","name": "","option":"","totalPrice": "", "weight":"","periode":"" ,"average":"","weightdry":"","totalVolume":"","costdry":"","size":"","row":"","color":"", "details": []};
          var detail={ "id": "", "wet": "", "volume": "","harga":"" };
          keluar.detailId=detailId;
          keluar.idPasta=idPasta;
          keluar.name=motiv;
...
<table  style="width: 100%" class="table-condensed" >
                  ...
                  <tr>
                      ...
                      <td>
                              ...
                              <input type="text" class="weightwet span11" id="weightwet" name="weightwet" style="width: 100%"  >
                  ...
                  <tr>
                      ...
                      <td>   
                              <input type="text" class="costdry span11" id="costdry" readonly="readonly"  name="costdry" style="width: 100%">
