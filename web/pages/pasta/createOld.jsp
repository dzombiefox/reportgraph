...
function amountPrice(tmpObj){
      ...
      $(document).ready(function(){          
          ...
          $.getJSON("pasta/getPasta.jsp?per="+per,function(data){  
              comboBody+="<option >Choose Pasta</option>";
          ...
          var weight=$("#weightwet").val();   
            ...
            $.Notify({                
             ...
             $.Notify({                
              ...
              var color=$("#color").val();
              var row=$("#jml").val();
              var keluar = { "name": "", "weight":"","periode":"","size":"","row":"","det":"","color":"", "details": []};
...
<div class="example" data-text="formula Pasta">	
      <br>
       <div class="datagrid">
       <fieldset>
    <legend>Formula Pasta </legend> 
...
<table  style="width: 100%" class="table-condensed" >
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <div class="input-control text full-size"> <input type="text" class="weightwet span11" id="weightwet" name="weightwet" style="width: 100%"  ></div>
