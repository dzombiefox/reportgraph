<script type="text/javascript">
 ...
 function saveType(){                   
  ...
  $.ajax({
       ...
       data:"&name="+name,
       success:function(){
       RefreshTable("#example","color/json.jsp");  
       $("#name").val("");
      }
  });
...
<ul class="breadcrumbs">
 ...
 <input type="submit" id="add" class="button success" value="Add Color"/>&nbsp; <!--<button class="button warning" id="edit" >Edit Color</button>&nbsp; --><button class="button alert" id="remove" onclick="removeType()">Remove</button>
