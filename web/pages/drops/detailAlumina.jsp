...
String query="select  b.detail_id,b.name,b.date,b.weight,s.size,p.periode from alumina b JOIN SIZE s on b.size_id=s.size_id join periode p on b.periode=p.id  where detail_id='"+id+"'";
