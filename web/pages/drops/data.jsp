<script>
   ...
   $(document).ready(function(){ 
    ...
    $("#remove").attr("disabled","disabled");
        ...
        ajax: "alumina/json.jsp"
        });
        $("#doneRemove").click(function(){
            $.ajax({
                url:"alumina/remove.jsp",
                data:"id="+id,
                success:function(){
                     RefreshTable("#example","alumina/json.jsp");
                     closeDialog();
                }
            });
...
$('#detail').click(function(){
    $("#myIframe").attr('src', 'alumina/detailAlumina.jsp?id='+id);
    $('#dialog').dialog('open');
});
