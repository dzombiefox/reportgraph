...
<table style="width: 100%" >
        <tr>
            ...
            <td style="width: 20%"><div class="input-control text full-size">  <input type="text" id="code"   /></div></td>
            <td>&nbsp;</td>
            <td style="width: 6%">VOLUME</td>
            <td style="width: 5%"><div class="input-control text small-size">  <input type="text" id="volume" style="width: 200px; font-size:1.2em;" /><button class="button" id="addRow"><span class="mif-plus"></span></button></div></td>
            <td>
