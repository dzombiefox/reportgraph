...
$(document).ready(function(){   
          ...
          {
          comboBody+="<option value='"+item.id+"'>"+item.name+"&nbsp;"+item.size+"&nbsp;"+item.color+"&nbsp;("+item.line+")</option>";
          });
          $("#cari").html(comboBody);        
          });
          });
      ...
      $("#go").click(function(){
       ...
       for(var i=0;i<length;i++){
           ...
           $.ajax({
               ...
               var name=m[i].name;
               var amountPrice=m[i].amountPrice;
               var amountValue=parseFloat(m[i].amountValue);
               ...
               $("#name").val(name);
               $("#totalPrice").val(amountPrice);
               $("#totalVolume").val(amountValue);              
       ...
       $("#size").html(items);        
        ...
        $("#costdry").mouseover(function(){
         ...
         $("#simpan").click(function(){
          ...
          var color=$("#color").val();
          var row=$("#jml").val();
          var keluar = {"detailId":"", "idInk":"", "name": "", "totalPrice": "","totalVolume":"","size":"","periode":"","row":"","det":"","color":"", "details": []}
       ...
       $.ajax({
        ...
        var line="";
              $.getJSON("ink/getLine.jsp",function(data){
      
  $.each(data,function(index,item) 
    {
      line+="<option value='"+item.id+"'>"+item.name+"</option>";
    });
    $("#line").html(line); 
...
<table  style="width: 100%" class="table-condensed" >
                  ...
                  <tr>
                      ...
                      <td>
                         ...
                         <button class="btn btn-primary btn-block" type="button" id="simpan"> <i class="fa fa-save"></i> Save Formula</button>
