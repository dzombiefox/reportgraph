       ...
       $("#size").html(items);        
        ...
        $("#costdry").mouseover(function(){
         ...
         $("#simpan").click(function(){
          ...
          var per=$("#periode").val();
          var color=$("#color").val();
          var keluar = {"detailId":"", "idEngobe":"","name": "", "totalPrice": "", "weight":"","periode":"" ,"average":"","weightdry":"","totalVolume":"","costdry":"","size":"","row":"","color":"", "details": []};
          var detail={ "id": "", "wet": "", "volume": "","harga":"" };
          keluar.detailId=detailId;
          keluar.idEngobe=idEngobe;
          keluar.name=motiv;
