...
String query="select * from engobe join motif on engobe.motif_id=motif.motif_id join color on engobe.color_id=color.color_id join weight on engobe.id_weight=weight.id_weight";
