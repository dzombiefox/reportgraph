<script>
   ...
   $(document).ready(function(){ 
    ...
    $("#remove").attr("disabled","disabled");
        ...
        ajax: "engobe/json.jsp"
        });
        $("#doneRemove").click(function(){
            $.ajax({
                url:"engobe/remove.jsp",
                data:"id="+id,
                success:function(){
                     RefreshTable("#example","engobe/json.jsp");
                     closeDialog();
                }
            });
...
$('#detail').click(function(){
    $("#myIframe").attr('src', 'engobe/detailEngobe.jsp?id='+id);
    $('#dialog').dialog('open');
});
