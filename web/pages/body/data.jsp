...
$(document).ready(function(){ 
    ...
    $("#doneRemove").click(function(){
          $.ajax({
                ...
                data:"id="+id,
                success:function(){
                     RefreshTable("#example","body/json.jsp");
                     closeDialog();
                }
            });
         });
...
$('#detail').click(function(){
    $("#myIframe").attr('src', 'body/detailBody.jsp?id='+id);
    $('#dialog').dialog('open');
});
...
<table width="25%" >
        <tr>
            <td width="125px">
                <input id="detail" type="submit" value="Detail Body" style="width: 98%" class="open-dialog button success"/>
            </td>
            <td width="120px">
