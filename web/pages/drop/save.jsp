...
String weight=jsonObj.get("weight").toString();
    ...
    a.setPeriode(Integer.parseInt(jsonObj.get("periode").toString()));
        ...
        String save="insert into drops(detail_id,name,size_id,date,weight,status,periode)values('"+detailId+"','"+a.getName()+"','"+a.getSize()+"','"+a.getDate()+"','"+weight+"','0','"+a.getPeriode()+"')";
        c.ManipulasiData(save);
            for(int i=0;i<=row;i++){
                        ...
                        String sdetail="insert into dropDetail(detail_id,items_id,priceWet,volume,price,periode)values('"+detailId+"','"+id+"','"+uprecent+"','"+volume+"','"+price+"','"+a.getPeriode()+"')";
