...
<body>
 <div id="mydiv" >
  ...
  out.print("<h4 align='center'>Graphic Production "+nline+" &nbsp;"+monthString+"&nbsp;"+y+" Real Nyata</h4>");
    ...
    String query="select ((b.sch*CONVERT(decimal(16,2),b.pkw1/100.0)*(sell_1-hpp_1))+(b.sch*CONVERT(decimal(16,2),b.pkw2/100.0)*(sell_2-hpp_2))+(b.sch*CONVERT(decimal(16,2),b.pkw3/100.0)*(sell_3-hpp_3))+(b.sch*CONVERT(decimal(16,2),b.pkw4/100.0)*(sell_4-hpp_4))+(b.sch*CONVERT(decimal(16,2),b.pkw5/100.0)*(sell_5-hpp_5)))/1000000 as proSch,((kw1*(sell_1-hpp_1))+(kw2*(sell_2-hpp_2))+(kw3*(sell_3-hpp_3))+(kw4*(sell_4-hpp_4))+(kw5*(sell_5-hpp_5)))/1000000as proReal,((b.sch*CONVERT(DECIMAL(16,2),b.pkw1/100.0)*hpp_1)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw2/100.0)*hpp_2)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw3/100.0)*hpp_3)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw4/100.0)*hpp_4)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw5/100.0)*hpp_5) )/1000000 as valSch,((kw1*hpp_1)+(kw2*hpp_2)+(kw3*hpp_3)+(kw4*hpp_4)+(kw5*hpp_5))/1000000 as valReal  from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and date between '"+begin+"' and '"+end+"' order by a.date asc ";
...
<div class="datagrid">
    <div class="inner"> 
      ...
      <%
       String queryDate="select * from report  join persen on report.persen_id=persen.persen_id join line on persen.line_id=line.line_id where line.line_id='"+li+"' and date between '"+begin+"' and '"+end+"' order by date asc";
            ...
            out.print("</tr>");   
            out.print("<tr >");
            String querySch="select ((b.sch*b.pkw1)+(b.sch*b.pkw2)+(b.sch*b.pkw3)+(b.sch*b.pkw4)+(b.sch*b.pkw5))/100 as hasil from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
            ...
            String queryQtyReal="select ((b.sch*b.pkw1)+(b.sch*b.pkw2)+(b.sch*b.pkw3)+(b.sch*b.pkw4)+(b.sch*b.pkw5))/100 as sch,a.kw1+a.kw2+a.kw3+a.kw4+a.kw5 as qty from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
            ...
            while(rkw1.next()){
                ...
                Double qty=rkw1.getDouble("kw1")+rkw1.getDouble("kw2")+rkw1.getDouble("kw3")+rkw1.getDouble("kw4")+rkw1.getDouble("kw5");
            ...
            while(rkw2.next()){
                ...
                totKw2+=kw2;
                Double qty=rkw2.getDouble("kw1")+rkw2.getDouble("kw2")+rkw2.getDouble("kw3")+rkw2.getDouble("kw4")+rkw2.getDouble("kw5");
            ...
            while(rkw3.next()){
                ...
                totKw3+=kw3;
                Double qty=rkw3.getDouble("kw1")+rkw3.getDouble("kw2")+rkw3.getDouble("kw3")+rkw3.getDouble("kw4")+rkw3.getDouble("kw5");
            ...
            while(rkw4.next()){
                ...
                totKw4+=kw4;
                Double qty=rkw4.getDouble("kw1")+rkw4.getDouble("kw2")+rkw4.getDouble("kw3")+rkw4.getDouble("kw4")+rkw4.getDouble("kw5");
            ...
            out.print("</tr >");
            out.print("<tr class='rw'>");
            out.print("<td align='center' style='border-left:1px solid black;border-top:1px solid #D0D0D0 ;border-bottom:1px solid black '>KW 5</td>");
            Double totKw5=0.0;
            while(rkw5.next()){
                Double kw5=rkw5.getDouble("kw5");
                totKw5+=kw5;
                Double qty=rkw5.getDouble("kw1")+rkw5.getDouble("kw2")+rkw5.getDouble("kw3")+rkw5.getDouble("kw4")+rkw5.getDouble("kw5");
            ...
            out.print("<td align='center' style='border-right:1px solid black;border-top:1px solid #D0D0D0 ;border-bottom:1px solid black'>KW 5</td>");
            out.print("</tr >");
            out.print("<tr >");
            out.print("<td style='border-top:1px solid black'>VAL SCH</td>");
            String queryValsch="select ((b.sch*CONVERT(DECIMAL(16,2),b.pkw1/100.0)*hpp_1)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw2/100.0)*hpp_2)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw3/100.0)*hpp_3)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw4/100.0)*hpp_4)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw5/100.0)*hpp_5) )/1000000 as hasil from report a join persen b on a.persen_id=b.persen_id  where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
            ...
            String queryValReal="select ((b.sch*CONVERT(DECIMAL(16,2),b.pkw1/100.0)*hpp_1)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw2/100.0)*a.hpp_2)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw3/100.0)*hpp_3)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw4/100.0)*a.hpp_4)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw5/100.0)*hpp_5) )/1000000 as valSch,(a.kw1*a.hpp_1)+(a.kw2*a.hpp_2)+(a.kw3*a.hpp_3)+(a.kw4*hpp_4)+(a.kw5*a.hpp_5)as hasil,(((b.sch*b.pkw1)+(b.sch*b.pkw2)+(b.sch*b.pkw3)+(b.sch*b.pkw4)+(b.sch*b.pkw5))/100)/ISNULL(NULLIF(hpp_1,0),1) as banding from report a join persen b on a.persen_id=b.persen_id  where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
            ...
            out.print("<td style='border-top:1px solid #D0D0D0'>Variant</td>");
                String queryVariantVal="select ((((b.sch*CONVERT(DECIMAL(16,2),b.pkw1/100.0)*hpp_1)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw2/100.0)*hpp_2)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw3/100.0)*hpp_3)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw4/100.0)*hpp_4)+(b.sch*CONVERT(DECIMAL(16,2),b.pkw5/100.0)*hpp_5) ))-((kw1*hpp_1)+(kw2*hpp_2)+(kw3*hpp_3)+(kw4*hpp_4)+(kw5*hpp_5)))/1000000 as variant from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc ";
            ...
            String queryvalSch=" select ((b.sch*CONVERT(decimal(16,2),b.pkw1/100.0)*(sell_1-hpp_1))+(b.sch*CONVERT(decimal(16,2),b.pkw2/100.0)*(sell_2-hpp_2))+(b.sch*CONVERT(decimal(16,2),b.pkw3/100.0)*(sell_3-hpp_3))+(b.sch*CONVERT(decimal(16,2),b.pkw4/100.0)*(sell_4-hpp_4))+(b.sch*CONVERT(decimal(16,2),b.pkw5/100.0)*(sell_5-hpp_5)))/1000000 as proSch from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
            ResultSet rvalSch=c.GetData(queryvalSch);
            ...
            String queryProReal="select ((b.sch*CONVERT(decimal(16,2),b.pkw1/100.0)*(a.sell_1-a.hpp_1))+(b.sch*CONVERT(decimal(16,2),b.pkw2/100.0)*(a.sell_2-a.hpp_2))+(b.sch*CONVERT(decimal(16,2),b.pkw3/100.0)*(a.sell_3-a.hpp_3))+(b.sch*CONVERT(decimal(16,2),b.pkw4/100.0)*(a.sell_4-a.hpp_4))+(b.sch*CONVERT(decimal(16,2),b.pkw5/100.0)*(a.sell_5-a.hpp_5)))/1000000 as proSch ,((a.kw1*(a.sell_1-a.hpp_1))+(a.kw2*(a.sell_2-a.hpp_2))+(a.kw3*(a.sell_3-a.hpp_3))+(a.kw4*(a.sell_4-a.hpp_4))+(a.kw5*(a.sell_5-a.hpp_5)))/1000000 as pro from report a join persen b on a.persen_id=b.persen_id where line_id='"+li+"' and date between '"+begin+"' and '"+end+"' order by date asc";
            ...
            out.print("<tr >");
            out.print("<td  style='border-top:1px solid #D0D0D0;'>Variant</td>");
                String varianPro="select (((b.sch*CONVERT(decimal(16,2),b.pkw1/100.0)*(sell_1-hpp_1))+(b.sch*CONVERT(decimal(16,2),b.pkw2/100.0)*(sell_2-hpp_2))+(b.sch*CONVERT(decimal(16,2),b.pkw3/100.0)*(sell_3-hpp_3))+(b.sch*CONVERT(decimal(16,2),b.pkw4/100.0)*(sell_4-hpp_4))+(b.sch*CONVERT(decimal(16,2),b.pkw5/100.0)*(sell_5-hpp_5)))/1000000)-(((a.kw1*(a.sell_1-a.hpp_1))+(a.kw2*(a.sell_2-a.hpp_2))+(a.kw3*(a.sell_3-a.hpp_3))+(a.kw4*(a.sell_4-a.hpp_4))+(a.kw5*(a.sell_5-a.hpp_5)))/1000000)as variant from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"'  and a.date between '"+begin+"' and '"+end+"'  order by a.date asc";
...
DefaultCategoryDataset data = new DefaultCategoryDataset();
 String x="select ((b.sch*b.pkw1)+(b.sch*b.pkw2)+(b.sch*b.pkw3)+(b.sch*b.pkw4)+(b.sch*b.pkw5))/100 as sch,a.kw1+a.kw2+a.kw3+a.kw4+a.kw5 as qty,0.9*a.kw1 as kw1sch,a.kw1 as kw1 from report a join persen b on a.persen_id=b.persen_id where b.line_id='"+li+"' and a.date between '"+begin+"' and '"+end+"' order by a.date asc";
