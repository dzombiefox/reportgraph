...
String tsch="select sum(sch)as tot from report join line on report.line_id=line.line_id where line.line_id='"+li+"' and date between '"+begin+"' and '"+end+"'";
...
String valSch="select sum(x) as total from(select (sum(sch)*(hpp_qty1))/1000000 as x,sum(sch)as schedule,sell_qty1 as hargaJual,hpp_qty1 as hpp1 from report  join line on report.line_id=line.line_id where line.line_id='"+li+"'  and date between '"+begin+"' and '"+end+"'  group by sch,hpp_qty1,sell_qty1)a";
...
String proSch="select sum(x)as total from(select(sum(sch)*(sell_qty1-hpp_qty1))/1000000 as x,sum(sch)as schedule,hpp_qty1 as hppqty,sell_qty1 as hargaJual,hpp_qty1 as hpp1 from report  join line on report.line_id=line.line_id where line.line_id='"+li+"'  and date between '"+begin+"' and '"+end+"'  group by sch,hpp_qty1,sell_qty1,hpp_qty1)a";
