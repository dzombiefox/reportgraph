...
<%  
        ...
        String query="insert into report(date,item_code,sch,line_id,kw1,hpp_1,sell_1,kw2,hpp_2,sell_2,kw3,hpp_3,sell_3,kw4,hpp_4,sell_4,kw5,hpp_5,sell_5)values('"+tanggal+"','"+name+"','"+sch+"','"+line+"','"+persen+"','"+kw1+"','"+hpp1+"','"+sell1+"','"+kw2+"','"+hpp2+"','"+sell2+"','"+kw3+"','"+hpp3+"','"+sell3+"','"+kw4+"','"+hpp4+"','"+sell4+"','"+kw5+"','"+hpp5+"','"+sell5+"')";
