  ...
  if( !regex.test(key) ) {
    ...
    function countBenefit(){
     ...
     function saveCost(){
       ...
       {
           var keluar = { "name":"","tanggal":"" ,"line":"","sch":"","kw1":"","kw2":"","kw3":"","kw4":"","kw5":"","hpp1":"","hpp2":"","hpp3":"","hpp4":"","hpp5":"","sell1":"","sell2":"","sell3":"","sell4":"","sell5":""};
           keluar.name=name;
           ...
           var json = JSON.stringify(keluar);
            $.ajax({
            url:"cost/saveOld.jsp",
            data: {data:json},
            success:function(data){
            kosong();
            RefreshTable("#example","cost/jsonReportOld.jsp");
            }
    ...
    function updateCost(){
       ...
       {
           var keluar = { "id":"","name":"","tanggal":"" ,"line":"","sch":"","kw1":"","kw2":"","kw3":"","kw4":"","kw5":"","hpp1":"","hpp2":"","hpp3":"","hpp4":"","hpp5":"","sell1":"","sell2":"","sell3":"","sell4":"","sell5":""};
           keluar.id=id;
           keluar.name=name;
           keluar.tanggal=tanggal;
           keluar.line=line;
    ...
    $(document).ready(function(){
      $("#btn_arrow").click(function(e){
          e.preventDefault();
         $.getJSON("jsonData/data.jsp",function(data){
              var combo = "<table name='list_combo' cellpadding='2' cellspacing='2'>";
         $.each(data,function(index,item) 
         
    {
      combo +="<tr id='rows' key='"+item.id+"' ><td>"+item.id+"</td><td>"+item.name+"</td><td>"+item.alamat+"</td></tr>";
    });
      combo +="</table>";
     $("#show_multicombo").html(combo).fadeIn();
        ...
        var kode,date,line,sch,kw1,kw2,kw3,kw4,kw5,hpp,hpp2,hpp2,hpp3,hpp4,hpp5,sell1,sell2,sell3,sell4,sell5;
            var id;
            $("#sch").number( true );
            $("#kw1").number( true );
            $("#kw2").number( true );
...
$("#add").click(function(){
   ...
   $(".dialog-close-button").click(function(){
    ...
    $("#editData").click(function(){
        ...
        $("#name").val(kode);
        $("#tanggal").val(date);
        $("select#line option").each(function() { this.selected = (this.text == line); });
        $("#sch").val(sch);
        $("#kw1").val(kw1);
        $("#kw2").val(kw2);
        $("#kw3").val(kw3);
         ...
         $.each(data,function(index,item) 
    {
     ...
     $("#lineGrafik").html(line);
        ...
        $("#look").click(function(){
			...
			var up=$("#up").val();
			var down=$("#down").val();
            document.location="admin.jsp?page=cost/grafik&begin="+begin+"&end="+end+"&line="+line+"&up="+up+"&down="+down+" ";
...
<ul class="breadcrumbs">
 ...
 <div data-role="dialog" id="dialogGrafik" class="padding20" data-close-button="true" data-overlay="true" data-overlay-color="op-dark" style="width:500px;">
	...
	<label>Setup </label><br>
           <div class="input-control text full-size" >
                     <div class="input-control text full-size">
             UP&nbsp;&nbsp;<input type="text" id="up" style="width: 100px">&nbsp; DOWN&nbsp;&nbsp;<input type="text" id="down" style="width: 100px">
       
         </div>
    </div>
	<br><br>
         <button class="button primary" id="look">View Grafik </button>&nbsp;<button class="button success" id="viewData">View Data </button>&nbsp;<button class="button primary" id="sinc">Sincronize</button>
     </div>
...
<tr>
 ...
 <tr>
            ...
            <td><div class="input-control text small-size">
                    ...
                    <input type="text" id="hpp1"  value="0" readonly>
</div>&nbsp;Sell&nbsp;<div class="input-control text small-size">
                    <input type="text" id="sell1"  value="0" readonly>
</div>
           </td>
</tr>  
<tr>
            ...
            <td><div class="input-control text small-size">
                    <input type="text" id="kw2"  value="0" >
</div>&nbsp;HPP &nbsp;<div class="input-control text small-size">
                    <input type="text" id="hpp2" value="0" readonly>
</div>&nbsp;Sell&nbsp;<div class="input-control text small-size">
                    <input type="text" id="sell2"  value="0" readonly>
</div>
           </td>
</tr>   
 <tr>
            ...
            <td><div class="input-control text small-size">
                    <input type="text" id="kw3"  value="0" >
</div>&nbsp;HPP &nbsp;<div class="input-control text small-size">
    <input type="text" id="hpp3"  value="0" readonly>
</div>&nbsp;Sell&nbsp;<div class="input-control text small-size">
                    <input type="text" id="sell3" value="0" readonly>
</div>
           </td>
</tr>  
 <tr>
            ...
            <td><div class="input-control text small-size">
                    ...
                    <input type="text" id="hpp4" value="0" readonly >
</div>&nbsp;Sell&nbsp;<div class="input-control text small-size">
                    <input type="text" id="sell4" value="0" readonly>
</div>
          </td>
</tr>
 <tr>
            ...
            <td><div class="input-control text small-size">
                    ...
                    <input type="text" id="hpp5" value="0" readonly >
</div>&nbsp;Sell&nbsp;<div class="input-control text small-size">
                    <input type="text" id="sell5"  value="0" readonly >
</div>
          </td>
</tr>
...
<button class="button success" id="add">Add Price Cost</button>&nbsp;  <button class="button info" id="editData">Edit Data</button>&nbsp;<button class="button alert" id="remove">Remove</button>&nbsp; <button class="button primary" id="grafik">Option</button>&nbsp; <button class="button default" id="sink">Sinc Price</button>
